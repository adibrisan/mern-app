...
const updatePlaceById = async (req, res, next) => {
  ...
  try {
    ...
    const error = new HttpError(
      "Something went wrong. Could not update this place fields.",
      500
    );
...
const deletePlace = async (req, res, next) => {
  ...
  try {
    ...
    const error = new HttpError(
      "Could not find the place you want to delete.",
      500
    );
  ...
  try {
    ...
    const error = new HttpError("Could not delete this place.", 500);
